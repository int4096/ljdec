...
sed -i "s/ip1/$4/g" ceph.conf
sed -i "s/ip2/$5/g" ceph.conf
sed -i "s/ip3/$6/g" ceph.conf
sed -i "s|subnet|$7|g" ceph.conf
...
sed -i "s/ip1/$4/g" start.sh
sed -i "s/ip2/$5/g" start.sh
sed -i "s/ip3/$6/g" start.sh
bash start.sh
bash scm $5
bash scm $6
bash smon $4 $1
bash smon $5 $2
bash smon $6 $3
ssh $4 systemd-escape --unescape ceph-mon 
ssh $4 "systemctl start ceph-mon\@$1"
ssh $4 "systemctl enable ceph-mon\@$1"
ssh $5 systemd-escape --unescape ceph-mon 
ssh $5 "systemctl start ceph-mon\$2"
ssh $5 "systemctl enable ceph-mon\@$2"
ssh $6 systemd-escape --unescape ceph-mon 
ssh $6 "systemctl start ceph-mon\@$3"
ssh $6 "systemctl enable ceph-mon\@$3"
